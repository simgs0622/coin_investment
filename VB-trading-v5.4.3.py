...
# 세팅
coin_list = ['KRW-BTC', 'KRW-ETH', 'KRW-VET', 'KRW-OMG', 'KRW-ETC']
investing_limit = 17200000
buy_check = {'KRW-BTC': 1}
high_prices = {'KRW-ETH': [4848000]}
...
#             print(now, buy_check, target_prices, investing_amts, high_prices)
            ...
            for ind, coin in enumerate(coin_list):
                ...
                if buy_check[coin] == 1:
                    ...
                    if coin == 'KRW-OMG':
                        if (0.8 * 17047 > current_price) or (1.2 * 17047 < current_price):
                            units = get_balance(coin_s)
                            if units > 0.00000001:
                                upbit.sell_market_order(coin, units)
                            high_prices[coin] = [0]
